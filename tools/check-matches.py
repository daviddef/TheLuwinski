...
AMBIGUOUS = {
    ...
    # Giddins/Giddings. James Giddins of Norton End, Baldock, b.1815, is Derrick's
    # 3x-great-grandfather, proved from the 1861 and 1871 censuses on 16 Sept 2026.
    # Two living match holders carry the surname, 43.36 and 62.89 cM, both cluster 12.
    # I FIRST WROTE HERE THAT THIS WAS "NOT A COINCIDENCE". IT PROBABLY IS ONE.
    # The larger of the two trees was then read: its George Giddins, 1846-1890, is born
    # at WITHYBROOK, WARWICKSHIRE, son of RICHARD — not at Baldock, and not a son of
    # James. That tree's other surnames (Ratcliffe, Conway, Woodhams, Wall, McMellon)
    # are nowhere near Hertfordshire. SO THE SURNAME IS NOT THE LINK, and if these two
    # match for a reason it runs through some other line in their ancestry.
    # The entry stays, because the reason for allowing it is unchanged and simpler than
    # I made it: THE RULE PROTECTS LIVING PEOPLE, NOT DEAD ONES. A man born in 1815
    # identifies nobody alive. The two holders remain unnamed on the site.
    "giddins", "giddings",
