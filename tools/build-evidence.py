...
MANIFEST = {
 ...
 "leibholz-schmul-marriage-1874.tsv": (["name"], "Hammerstein, from a document at last — the 1874 marriage, and a generation above", "Archiwum Państwowe w Bydgoszczy, USC Szubin Miasto sygn. 141, akt małżeństwa nr 9/1874, on genealogiawarchiwach.pl, read 22 September 2026", "person"),
 ...
 "adressbuch-fulltext-sweep.tsv": ([], "Five rows put to the Berlin directories' full-text index at once", "digital.zlb.de Solr full-text index, queried 22 September 2026 with controls", "ref"),
 "trove-and-ryerson-22-september.tsv": ([], "Trove answered and corrected its own row; Ryerson's coverage settled without a search", "trove.nla.gov.au and ryersonindex.org, 22 September 2026", "ref"),
 "negatives-control-audit.tsv": ([], "Does every negative show its instrument was answering?", "The archive's own /negatives/ page, all 34 rows read 22 September 2026; new controls run at gazettes.africa", "ref"),
 ...
 "leipholz-telephone-slot-audit.tsv": ([], "The telephone books read at the alphabetical slot — twelve volumes, and the name search was wrong in eight", "ZLB Berlin Amtliches Fernsprechbuch 1969-70 to 1980-81, slot read 22 September 2026", "ref"),
